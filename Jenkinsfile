        ...
        stage('Initialize environment') {
            ...
            steps {
                script {
                    ...
                    env.IMAGE_NAME = 'postsmith-hub.kr.ncr.ntruss.com/postsmith-api-manage'
        ...
        stage('Deploy K8s') {
            ...
            steps {
                script {
                    ...
                    k8s.deploy("postsmith-api-manage-app-deploy", "postsmith-api-manage-app", "postsmith-deploy", env.IMAGE_NAME, env.IMAGE_TAG)
